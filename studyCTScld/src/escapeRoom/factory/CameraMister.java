...
public class CameraMister implements ICameraEscape{
    private String nume;
    private int dificultate;
    private int timpRezolvare;
    private double pret;

    public CameraMister(String nume, int dificultate, int timpRezolvare, double pret) {
        this.nume = nume;
    ...
    public void afiseazaDetalii() {
        System.out.println("CameraMister{" +
                "nume='" + nume + '\'' +
